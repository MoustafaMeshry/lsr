...
def get_parameters():
    ...
    parser.add_argument('--model_save_path', type=str, default='/fs/vulcan-projects/two_step_synthesis_meshry/face_segmentation/CelebAMask-HQ/face_parsing/models')
    parser.add_argument('--sample_path', type=str, default='./samples')
    parser.add_argument('--test_image_path', type=str, default='/fs/vulcan-projects/two_step_synthesis_meshry/preprocessed_voxceleb2/test') 
    ...
    parser.add_argument('--person_id', type=str, default='id01437') 
